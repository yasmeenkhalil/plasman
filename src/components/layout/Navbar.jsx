  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <a href="/" className="flex flex-col items-center justify-center group select-none shrink-0">
          <img 
            src={logoImg} 
          ...
          {navItems.map((item) => (
            <li key={item} className="relative group/item">
              <a 
                ...
                className="hover:text-plasman-purple transition-colors flex items-center gap-1 py-2 tracking-wide"
              >
                {item}
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="hidden md:block">
            <button className="bg-plasman-dark hover:bg-plasman-deep text-white font-bold text-[14px] px-6 py-3.5 rounded-xl transition-all duration-200 active:scale-[0.98] tracking-wide">
              Book a Meeting
            </button>
          </div>

          <button aria-label="Toggle Menu" className="w-11 h-11 bg-plasman-light bg-opacity-40 hover:bg-plasman-light rounded-xl flex flex-col justify-center items-center gap-1.5 transition-colors duration-200 text-plasman-dark">
