...
export default function CardContainer({ children, className = "", index = 0 }) {
  return (
    /* 
      1. تم زيادة عمق القطع المائل إلى 48px ليصبح كبيراً وواضحاً جداً.
      2. تم زيادة سمك البوردر لـ p-[2px] (2 بكسل) وتغميق لونه لـ [#dcdfe3] ليصبح بارزاً.
    */
    <motion.div
    ...
    >
      {/* الكارد الداخلي بالخلفية البيضاء وحواف حادة تماماً ومطابقة للقطع الخارجي */}
      <div
        className={`
