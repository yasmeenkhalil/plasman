  ...
  return (
    <section className="bg-white  px-8 md:p-12 select-none rounded-3xl border border-slate-200/80 shadow-sm mb-10">
      <div className="mx-auto max-w-[1300px]">
        ...
        {/* الحاوية الرئيسية بنظام الـ Grid المتجاوب والفسيح */}
        <div className="grid gap-16 lg:grid-cols-12 items-center">
          
          {/* ================= الجانب الأيسر: معرض الصور المتداخل والكرت العائم ================= */}
          <div className="lg:col-span-5 relative w-full max-w-md mx-auto lg:mx-0 min-h-[420px] md:min-h-[460px]">
            
            {/* 1. الصورة الخلفية الكبيرة المستديرة الحواف */}
            ...
            {/* 2. الصورة الأمامية الصغيرة المتداخلة في الأسفل */}
            ...
            {/* 3. كرت سنوات الخبرة العائم الداكن - تم تعديل المواقع لضمان عدم الخروج من الشاشة */}
          ...
          <div className="lg:col-span-7 text-left lg:pl-4">
            ...
            {/* الفقرة التمهيدية الوصفية المريحة للعين */}
            ...
            {/* قائمة الأهداف الاستراتيجية على شكل نقاط بأيقونات موحدة النمط */}
            ...
            {/* الفوتر السفلي للقسم: أرقام الاتصال والتوقيع الفني */}
            <div className="flex flex-wrap items-center justify-between gap-6 max-w-xl">
              ...
              {/* التوقيع النصي الجمالي المكتوب بخط مائل أنيق */}
